                            ...
                            <form action="{{ route('admin.role.update', $role->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        aria-describedby="helpId" placeholder="" value="{{ $role->name }}">
                                </div>
                                ...
                                <div class="form-group" style="height: 300px; overflow-y: auto">
                                    ...
                                    @foreach ($routes as $route)
                                        <div class="form-check">
                                            <input  {{in_array($route->id, $permission_role) ? 'checked' : ''}} class="form-check-input role-item" type="checkbox" name="route[]"
                                ...
                                <button type="submit" style="margin-top: 5px;" class="btn btn-success">Update Role</button>
