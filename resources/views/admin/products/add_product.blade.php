                            ...
                            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="add_product" id=""
                                        aria-describedby="helpId" placeholder="" value="{{ old('add_product') }}">
                                        
                                </div>
                                <div class="form-group">
                                    <label for="">Image</label>
                                    <input type="file" class="form-control" name="add_image" id=""
                                        aria-describedby="helpId" placeholder="" value="{{ old('add_image') }}">
                                </div>
                               <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="add_price" id=""
                                            aria-describedby="helpId" placeholder="" value="{{ old('add_price') }}">
                                    </div>
                               ...
                               <label for="">Description</label>
                                <div class="form-group">
                                    <textarea style="width: -webkit-fill-available !important;" name="description" id="" cols="30" rows="10"></textarea>
                                </div>
