  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 ftco-animate">
        ...
        <p>
          <img src="website/images/image_1.jpg" alt="" class="img-fluid">
        </p>
        ...
        <p>
          <img src="website/images/image_2.jpg" alt="" class="img-fluid">
        </p>
        ...
        <div class="about-author d-flex">
          <div class="bio align-self-md-center mr-5">
            <img src="website/images/person_4.jpg" alt="Image placeholder" class="img-fluid mb-4">
          </div>
      ...
      <div class="col-md-4 sidebar ftco-animate">
        ...
        <div class="sidebar-box ftco-animate">
          ...
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(website/images/image_3.jpg);"></a>
            <div class="text">
              <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
              <div class="meta">
                <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
