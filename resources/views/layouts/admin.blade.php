...
<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{ route('logoutAdmin') }}" class="btn btn-default btn-flat">Sign
                                            out</a>
                                    </div>
                                </li>
                            </ul>
    ...
    <script>
        ...
        //               $('#category-slug').text(data.slug);
        //               $('#category-created_at').text(data.created_at);
        //               $('#category-updated_at').text(data.updated_at);
        //           })
        //     });
    </script>
    @stack('script')
